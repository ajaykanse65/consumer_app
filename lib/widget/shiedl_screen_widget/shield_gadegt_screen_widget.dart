...
Widget buildShieldProgressbar(BuildContext context) {
  return SizedBox(
    height: 5,
    width: 264,
      ...
      return Stack(
        ...
        children: [
          Positioned(
              ...
              child: Image.asset('assets/zippy_shield/red_progressbar.png')),
          Positioned(
...
Widget buildShieldLaptopCard(BuildContext context, GestureTapCallback ontap){
...
Widget buildShieldMobileCard(BuildContext context,GestureTapCallback ontap){
  return GestureDetector(
      onTap: ontap,
      child: Container(
        decoration: BoxDecoration(
